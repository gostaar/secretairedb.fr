...
final class Version20250210111311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE google_token (id SERIAL NOT NULL, users_id INT DEFAULT NULL, access_token VARCHAR(255) NOT NULL, refresh_token VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C6DAA83467B3B43D ON google_token (users_id)');
        ...
        $this->addSql('ALTER TABLE google_token ADD CONSTRAINT FK_C6DAA83467B3B43D FOREIGN KEY (users_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE google_token DROP CONSTRAINT FK_C6DAA83467B3B43D');
