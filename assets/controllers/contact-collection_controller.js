...
export default class extends Controller {
    ...
    connect() {
        ...
        btn.innerText = this.addLabelValue || 'Ajouter un contact';
    ...
    addEditButton = (item) => {
        ...
        const imageId = element.getAttribute('data-contact-id');
            
        // Ajouter les attributs data-bs-toggle et data-bs-target
        btn.setAttribute('data-bs-toggle', 'modal');
        btn.setAttribute('data-bs-target', `#editContact${imageId}`);
